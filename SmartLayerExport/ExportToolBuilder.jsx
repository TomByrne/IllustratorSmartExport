(function(pack){
	function ExportToolBuilder(docRef){
		this.init(docRef);
		return this;
	}
	...
	ExportToolBuilder.prototype={
		...
		showDialog: function(doArtboard, doLayer, doSymbol) {
			...
			// Export dialog
			this.toolPanel = new Window('dialog', 'Smart Layer Export');
			...
			this.exportPanel.onExportClicked = function() {
				...
				try{
					...
					if(scopedThis.exportSettings.directory){
						...
						scopedThis.exporter.runExport(scopedThis.bundleList, this.exportSettings, this.docRef.path);
					}
				}catch(e){
